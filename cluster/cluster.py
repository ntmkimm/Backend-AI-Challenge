...
output_folder = Path("/mlcv2/WorkingSpace/Personal/quannh/Project/Project/AIChallenge2025/dataset/group/400gr")
...
plt.savefig("cluster_labels_400.png", dpi=300)
